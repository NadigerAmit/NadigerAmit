...
Blockchain Development: In-depth knowledge of blockchain principles and decentralized application (dApp) creation using platforms such as Polkadot, substrate(account and utxo based) based .
